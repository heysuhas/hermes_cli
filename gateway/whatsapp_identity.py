...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$SR_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_sr_dir("platforms/whatsapp/session", "whatsapp/session")
