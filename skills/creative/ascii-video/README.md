...
Built for [SR Agent](https://github.com/SamsungResearch/sr-agent). Usable in any coding agent. Canonical source lives here; synced to [`SamsungResearch/sr-agent/skills/creative/ascii-video`](https://github.com/SamsungResearch/sr-agent/tree/main/skills/creative/ascii-video) via PR.
