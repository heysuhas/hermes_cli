#!/usr/bin/env python3
"""
SWE Runner with SR Trajectory Format

A runner that uses SR-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the SR-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses SR-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in SR format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches SR-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using SR-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with SR Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses SR-Agent's built-in execution environments
    and outputs trajectories in SR-Agent format.
    """
    ...
    def _convert_to_sr_format(
        ...
        """
        Convert internal message format to SR trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to SR trajectory format
        trajectory = self._convert_to_sr_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with SR trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with SR Trajectory Format")
    print("=" * 60)
