"""Client for uploading ``sr debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``sr debug share``.
...
NAS_BASE = os.environ.get(
    "SR_DIAGNOSTICS_BASE_URL", "https://portal.samsung.com"
)
...
_USER_AGENT = "sr-agent/debug-share"
