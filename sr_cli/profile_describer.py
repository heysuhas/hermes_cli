...
Used by ``sr profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``sr_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the SR Agent kanban board.
...
Rules:
  ...
  - Never write "SR Agent profile" or other meta-narration.
