...
Invoked by ``sr kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the SR Agent board.
...
def _profile_author() -> str:
    """Mirror of ``sr_cli.kanban._profile_author``."""
    return (
