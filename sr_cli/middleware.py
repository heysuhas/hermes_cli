"""SR middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "sr.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "sr.middleware.v1"
...
def apply_llm_request_middleware(
    ...
    **context: Any,
    ...
    provider kwargs before SR sends them.
    """
