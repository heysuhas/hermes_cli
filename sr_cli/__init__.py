"""
SR CLI - Unified command-line interface for SR Agent.

Provides subcommands for:
- sr chat          - Interactive chat (same as ./sr)
- sr gateway       - Run gateway in foreground
- sr gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `sr setup` on a fresh Pi.
    ...
    sr_cli/stdio.py::configure_windows_stdio() runs later from the entry
