...
def _has_sr_agent_browser() -> bool:
    ...
    # install.sh installs globally into $SR_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-SRHome", str(get_sr_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = sr_subprocess_env(inherit_credentials=False)
