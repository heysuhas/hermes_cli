...
Entry point: ``sr whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``sr_cli/main.py``).
...
SR gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures SR to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  SR needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the SR gateway in another terminal:")
    print("         sr gateway")
    print()
    ...
    print()
    print("  Docs: https://sr-agent.samsung.com/docs/user-guide/")
