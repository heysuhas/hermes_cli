...
Usage:
    sr pairing list              # Show all pending + approved users
    sr pairing approve <platform> <code>  # Approve a pairing code
    sr pairing revoke <platform> <user_id> # Revoke user access
    sr pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle sr pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: sr pairing {list|approve|revoke|clear-pending}")
        print("Run 'sr pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.sr/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'sr pairing list' to see pending codes.\n")
