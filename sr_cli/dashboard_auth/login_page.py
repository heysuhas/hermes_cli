...
Visual styling mirrors the Samsung Research design system (the
...
``tests/sr_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<main>
  ...
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the SR Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — SR Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
