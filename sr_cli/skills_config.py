"""
Skills configuration for SR Agent.
`sr skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.sr/config.yaml under:
...
from sr_cli.config import cfg_get, load_config, save_config
from sr_cli.colors import Colors, color
from sr_cli.platforms import PLATFORMS as _PLATFORMS
