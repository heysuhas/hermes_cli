#!/usr/bin/env python3
"""Build the SR Model Catalog — a centralized JSON manifest of curated models.
...
SR CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a SR release.
...
# Ensure SR_HOME is set for imports that touch it at module level.
os.environ.setdefault("SR_HOME", os.path.join(os.path.expanduser("~"), ".sr"))

from sr_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "sr-agent repo",
            "docs": "https://sr-agent.samsung.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
