#!/usr/bin/env python3
"""Build the SR Skills Index — a centralized JSON catalog of all skills.
...
`sr skills search/install` can use it without hitting the GitHub API.
...
# Ensure SR_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building SR Skills Index...", flush=True)
