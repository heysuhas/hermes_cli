...
DEFAULT_DATASETS = [
    "SamsungResearch/swe-terminus-agent-glm-kimi-minimax",
    "SamsungResearch/sr-agent-megascience-sft1",
    "SamsungResearch/SR-Agent-Thinking-GLM-4.7-SFT2",
    "SamsungResearch/SR-Agent-Thinking-GLM-4.7-SFT1",
    "SamsungResearch/terminal-tasks-glm-sr-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "SamsungResearch/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload SamsungResearch/{output_name} {final_output}")
