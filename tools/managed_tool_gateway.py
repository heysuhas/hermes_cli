...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "samsung.com"
...
def auth_json_path():
    """Return the SR auth store path, respecting SR_HOME overrides."""
    return get_sr_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`sr tools`, banner/status paint, provider
