...
Trust levels:
  - builtin:   Ships with SR. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.sr/\.env|\~/\.sr/\.env',
     "sr_env_access", "critical", "exfiltration",
     "directly references SR secrets file"),
    ...
    (r'\.sr/config\.yaml|\.sr/SOUL\.md',
     "sr_config_mod", "critical", "persistence",
     "references SR configuration files directly"),
...
# scan. `.skillignore` is the SR-native name; `.clawhubignore` is honored
