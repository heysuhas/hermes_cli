...
class LocalEnvironment(BaseEnvironment):
    ...
    def _run_bash(self, cmd_string: str, *, login: bool = False,
        ...
        if _IS_WINDOWS:
            import re
            # Match Windows absolute paths in the command string and replace backslashes with forward slashes
            # to prevent Git Bash from stripping them as escape characters.
