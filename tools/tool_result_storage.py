...
2. **Per-result persistence** (maybe_persist_tool_result): After a tool
   ...
   SANDBOX temp dir (for example /tmp/sr-results/{tool_use_id}.txt on
   standard Linux, or $TMPDIR/sr-results/{tool_use_id}.txt on Termux)
...
STORAGE_DIR = "/tmp/sr-results"
HEREDOC_MARKER = "SR_PERSIST_EOF"
...
def _heredoc_marker(content: str) -> str:
    ...
    return f"SR_PERSIST_{uuid.uuid4().hex[:8]}"
