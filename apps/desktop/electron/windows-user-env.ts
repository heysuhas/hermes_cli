...
// even though a fresh shell — and the SR CLI — sees it immediately. The
// desktop's SR_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\sr. Reading
