 ...
 *
 * A public install can end up with `origin=git@github.com:SamsungResearch/sr-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/SamsungResearch/sr-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/nousresearch/sr-agent'
