...
export interface PetInfo {
  ...
  // the SR "run" activity state uses the in-place running row).
 ...
 * SR_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'sr.desktop.pet-roam.v1'
