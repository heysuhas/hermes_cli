  ...
  it('shows failed title when navigate returns success=false', () => {
    const view = buildToolView(
      part({
        ...
        args: { url: 'https://sr-agent.samsung.com/docs' },
    ...
    expect(view.title).toBe('Failed to open sr-agent.samsung.com')
  })
  ...
  it('shows opened title on success', () => {
    const view = buildToolView(
      part({
        toolName: 'browser_navigate',
        args: { url: 'https://sr-agent.samsung.com/docs' },
        result: { success: true, url: 'https://sr-agent.samsung.com/docs', title: 'Docs' }
      }),
      ''
    )

    expect(view.status).toBe('success')
    expect(view.title).toBe('Opened sr-agent.samsung.com')
  })
})
