...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/sr'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('sr:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('sr:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask SR to
