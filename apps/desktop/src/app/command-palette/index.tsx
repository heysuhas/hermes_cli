...
import { getSRConfigRecord, listAllProfileSessions } from '@/sr'
...
// SR session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          },
          {
            icon: Download,
            id: 'cc-update-sr',
            keywords: ['update', 'upgrade', 'sr', 'version', 'system', 'restart'],
            label: cc.updateSR,
