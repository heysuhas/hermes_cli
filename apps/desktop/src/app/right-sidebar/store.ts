...
const TAKEOVER_KEY = 'sr.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which SR can't clear via the API — the user
 *  sees exactly what runs instead of SR silently deleting their creds. */
