import type { SRReviewFile } from '@/global'
...
export function buildReviewFlatList(files: SRReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: SRReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
