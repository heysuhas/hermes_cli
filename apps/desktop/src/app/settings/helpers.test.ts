...
describe('settings helpers', () => {
  ...
  it('reads and writes nested config paths', () => {
    const config: SRConfigRecord = { display: { theme: 'mono' } }
  ...
  describe('providerGroup', () => {
    ...
    it('prefers the longest matching prefix so CN/regional buckets win', () => {
      ...
      // SR_QWEN_ shares the SR_ stem with other integrations.
      expect(providerGroup('SR_QWEN_BASE_URL')).toBe('DashScope (Qwen)')
