...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/sr'
...
// / Program Files), which buried any files SR wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.srDesktop` is
    ...
    const settings = window.srDesktop?.settings
