...
export const en: Translations = {
  ...
  boot: {
    ready: 'SR Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading SR settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingSRDesktop: 'Starting SR Desktop…'
    },
    errors: {
      backgroundExited: 'SR background process exited.',
      backgroundExitedDuringStartup: 'SR background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your SR backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting SR Desktop.',
    ...
    native: {
      ...
      inputBody: 'SR is waiting for your response.',
      turnDoneTitle: 'SR finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to SR defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while SR is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'SR asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while SR was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let SR follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what SR is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen SR, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'SR checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading SR configuration...',
    ...
    gateway: {
      ...
      intro:
        'SR Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running SR backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset SR_DESKTOP_REMOTE_URL and SR_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private SR backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote SR backend.',
      remoteAuthHint:
        'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'SR Cloud',
      cloudDesc: 'Sign in once to SR Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'SR Cloud',
      cloudSignIn: 'Sign in to SR Cloud',
      cloudSignedIn: 'Signed in to SR Cloud',
      cloudNeedsSignIn: 'Sign in to SR Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your SR Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'SR Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of SR Cloud',
      cloudSignedOutMessage: 'Cleared the SR Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /sr.',
      ...
      restartingMessage: 'SR Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · SR ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. SR runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via sr curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As SR builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart SR to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update SR to generate pets.',
      backgroundHint: 'You can close this — SR will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure SR desktop' },
    ...
    srActiveSessions: (version, count) => `SR ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@sr:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent SR environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. SR will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the SR backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from SR. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting SR...',
    placeholderReconnecting: 'Reconnecting to SR…',
    ...
    attachUrlDesc: 'SR will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of SR can’t update itself from inside the app.',
    ...
    manualBody: 'You installed SR from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'SR will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the SR desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The SR updater takes over in its own window and reopens SR automatically when it’s done. Please don’t reopen SR yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. SR reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then SR reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'SR needs a one-time install',
    ...
    settingUpTitle: 'Setting up SR Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another SR CLI or desktop instance is running. Stop any running SR instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with SR Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'SR is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting SR…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run SR',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point SR at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — SR connects automatically',
    ...
    authorizeThere: 'Authorize SR there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize SR there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `SR Desktop v${version}`,
      ...
      gatewayTitle: 'SR inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. SR will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'SR is restarting...',
      askRestart: 'Ask SR to restart the server',
      lookingRestart: taskId => `SR is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'SR is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `SR finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'SR could not restart the server.',
      stillWorking:
        'SR is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'SR is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'SR gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.sr/config.yaml). SR won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'SR needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'SR needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart SR Desktop to use Save Image.',
    restartToSaveImages: 'Restart SR Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `sr gateway` running?'
    }
  },
