...
cd apps/desktop
XCURSOR_SIZE=24 SR_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/sr-typing
# → /tmp/sr-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/sr-typing.before.heapsnapshot
# → /tmp/sr-typing.after.heapsnapshot
```
