# nix/web.nix — SR Web Dashboard (Vite/React) frontend build
{ pkgs, srNpmLib, ... }:
let
  npm = srNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "sr-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../sr_cli/web_dist for the
