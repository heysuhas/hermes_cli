...
await build({
  ...
  // Skip the prebuilt @sr/ink bundle and inline the source instead:
  ...
  alias: { '@sr/ink': resolve(root, 'packages/sr-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The sr_cli launcher
