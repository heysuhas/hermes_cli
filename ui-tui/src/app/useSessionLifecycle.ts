...
import type { ScrollBoxHandle } from '@sr/ink'
import { evictInkCaches } from '@sr/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.SR_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
