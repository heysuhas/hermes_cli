import { Box, type ScrollBoxHandle, stringWidth, Text } from '@sr/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (SR_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (SR_DEV_CREDITS), lowest priority,
