...
Data file: $SR_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_SR_HOME = Path(os.environ.get("SR_HOME", Path.home() / ".sr"))
DATA_DIR = _SR_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
