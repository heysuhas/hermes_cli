...
metadata:
  sr:
    ...
    credits: |
      ...
      https://github.com/SamsungResearch/kanban-video-pipeline.
---
...
6. **The director never executes.** Even with the full `kanban + terminal +
   ...
   a `sr kanban create` call to a specialist profile. The kanban
