...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``sr logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # SR only initiates compaction in "sr" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping SR preflight compression for codex app-server "
                "(mode=%s); SR will not start thread compaction here.",
