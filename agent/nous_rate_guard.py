...
(3 SDK retries x 3 SR retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = os.path.join(os.path.expanduser("~"), ".sr")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, SR, ...) behind one endpoint.  A 429 can mean either:
