...
def resolve_billing_route(
    ...
    if provider_name == "nous" or base_url_host_matches(base_url or "", "inference-api.samsung.com"):
        return BillingRoute(provider="nous", model=model, base_url=base_url or _SR_DEFAULT_BASE_URL, billing_mode="official_models_api")
