...
def is_small_model(model_name: str | None) -> bool:
    """Check if the given model name pattern or config flags it as a small model."""
    try:
        ...
        if config_path.exists():
            ...
            if isinstance(cfg, dict):
                ...
                if isinstance(agent_cfg, dict) and agent_cfg.get("small_model") is True:
                    return True
    except Exception:
        pass
    ...
    patterns = ["3b", "4b", "5b", "7b", "8b", "qwen", "llama", "gemma", "ollama"]
