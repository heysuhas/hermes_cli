...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around SR's web-provider config and
        ...
        # native search engine for xAI sessions instead of SR's
        # configured web provider (Tavily/etc.), and those results bypass
        # SR's tool-trace / citation plumbing (they arrive baked into the
