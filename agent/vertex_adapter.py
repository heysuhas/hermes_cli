"""Vertex AI (Google Cloud) adapter for SR Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows SR to use Gemini models via Google Cloud with
...
# who installed plain `sr-agent` and only later selected a Gemini model.
try:
