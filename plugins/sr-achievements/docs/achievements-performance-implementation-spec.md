# SR Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.sr/plugins/sr-achievements/state.json` (existing unlock state)
  - `~/.sr/plugins/sr-achievements/scan_snapshot.json` (new)
  - `~/.sr/plugins/sr-achievements/scan_checkpoint.json` (new)
