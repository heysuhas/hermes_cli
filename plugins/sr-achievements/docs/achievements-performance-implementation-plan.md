# SR Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.sr/plugins/sr-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.sr/plugins/sr-achievements/scan_checkpoint.json`.
