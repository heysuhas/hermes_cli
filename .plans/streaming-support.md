# Streaming LLM Response Support for SR Agent
...
```
SR_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("SR_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `sr_cli/config.py` | 1 | +streaming config defaults |
