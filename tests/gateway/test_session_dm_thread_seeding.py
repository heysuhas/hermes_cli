...
def store(tmp_path, monkeypatch):
    ...
    ~/.sr/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at sr_state import time, before pytest's SR_HOME monkeypatch
    fires — the autouse fixture's SR_HOME override doesn't help here.)
    """
    import sr_state
