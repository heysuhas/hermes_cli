"""Session <-> workspace grouping key (sr_state.workspace_key).

The key is what `sr sessions list --workspace` groups/filters on. It is a
...
from sr_state import workspace_key
