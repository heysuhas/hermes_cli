...
The unit tests in tests/sr_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned sr-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/sr")
from sr_cli.service_manager import S6ServiceManager
