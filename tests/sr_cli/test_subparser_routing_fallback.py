...
The main() function in sr_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `sr -c model`
...
def _build_parser():
    """Build a minimal replica of the sr top-level parser."""
