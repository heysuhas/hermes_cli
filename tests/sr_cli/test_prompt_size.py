"""Tests for the ``sr prompt-size`` diagnostic (issue #34667)."""
...
from sr_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(sr_home, memory_text="", user_text=""):
    mem_dir = sr_home / "memories"
...
def _seed_skill(sr_home, name, description):
    skill_dir = sr_home / "skills" / "demo" / name
