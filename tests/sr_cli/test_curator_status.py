"""Tests for `sr curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import sr_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated SR_HOME with real agent-created skills on disk."""
    home = tmp_path / ".sr"
    skills = home / "skills"
    ...
    from sr_cli import curator as curator_cli
