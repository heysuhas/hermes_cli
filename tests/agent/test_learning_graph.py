...
def test_sr_meta_tolerates_non_dict():
    assert learning_graph._sr_meta({"metadata": "junk"}) == {}
    assert learning_graph._sr_meta({"metadata": {"sr": "junk"}}) == {}
    assert learning_graph._sr_meta({"metadata": {"sr": {"category": "x"}}}) == {"category": "x"}
