...
thinking phase.  SR's default cloud-stream stale detector
(``SR_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``SR_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
