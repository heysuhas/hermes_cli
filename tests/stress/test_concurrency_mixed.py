...
def worker_loop(worker_id: int, sr_home: str, result_file: str) -> None:
...
def reclaimer_loop(sr_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="sr_mixed_stress_")
    print(f"SR_HOME = {home}")
