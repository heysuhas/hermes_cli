...
const config: Config = {
  ...
  url: 'https://sr-agent.samsung.com',
  baseUrl: '/docs/',

  organizationName: 'SamsungResearch',
  projectName: 'sr-agent',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/SamsungResearch/sr-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://sr-agent.samsung.com/',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://github.com/SamsungResearch/sr-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https://discord.gg/SamsungResearch',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/SamsungResearch' },
            { label: 'GitHub Issues', href: 'https://github.com/SamsungResearch/sr-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://sr-agent.samsung.com/' },
            { label: 'GitHub', href: 'https://github.com/SamsungResearch/sr-agent' },
            { label: 'Samsung Research', href: 'https://samsung.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://samsung.com">Samsung Research</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
