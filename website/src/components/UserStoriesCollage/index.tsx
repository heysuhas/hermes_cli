  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the SR Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use SR &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with SR?{' '}
        <a
          href="https://github.com/SamsungResearch/sr-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/SamsungResearch" target="_blank" rel="noopener noreferrer">
          Samsung Research Discord
        </a>{' '}
