...
- **[Desktop mail with classic Outlook](/user-guide/features/outlook)** — local COM-based mailbox discovery, reading, and draft creation behind a provider-neutral tool contract.
