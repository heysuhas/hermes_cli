...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to SR Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to SR Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying SR core? Start with [Build a SR Plugin](../developer-guide/plugins/index.md)
- Building a new built-in core tool for SR itself? Start with [Adding Tools](./adding-tools.md)
...
You can also run a fully isolated SR instance (throwaway SR_HOME, separate Electron
userData, distinct Electron app name to avoid the single-instance lock):

```bash
scripts/dev-sandbox.sh python -m sr_cli.main
scripts/dev-sandbox.sh --persistent python -m sr_cli.main desktop  # state survives restarts, but lives in the worktree :)
```
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.sr/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.sr` — use `get_sr_home()` from `sr_constants` for code paths and `display_sr_home()` for user-facing messages. See [AGENTS.md](https://github.com/SamsungResearch/sr-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- **Discord**: [discord.gg/SamsungResearch](https://discord.gg/SamsungResearch)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/SamsungResearch/sr-agent/blob/main/LICENSE).
