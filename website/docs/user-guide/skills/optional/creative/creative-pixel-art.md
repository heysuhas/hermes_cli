...
| | |
|---|---|
| Source | Optional — install with `sr skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.sr/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.sr/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — SR installs package this)
