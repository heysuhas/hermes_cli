...
| | |
|---|---|
| Source | Optional — install with `sr skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), SR Agent |
| License | MIT |
...
The script reads `${SR_HOME:-~/.sr}/.env` for two optional defaults:
...
Helper script: `~/.sr/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.sr/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${SR_HOME:-~/.sr}/.env`.
...
```bash
python3 ~/.sr/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.sr/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
