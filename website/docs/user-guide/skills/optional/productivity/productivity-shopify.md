...
| | |
|---|---|
| Source | Optional — install with `sr skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"SR","productType":"Apparel","tags":["test"]}}'
```
