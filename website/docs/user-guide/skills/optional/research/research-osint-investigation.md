...
| | |
|---|---|
| Source | Optional — install with `sr skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | SR Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $SR_OSINT_CACHE/icij/ (default: ~/.cache/sr-osint/icij/).
...
# Set SR_OSINT_UA=your-app/1.0 (your@email) to identify yourself
