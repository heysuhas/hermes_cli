...
| | |
|---|---|
| Source | Optional — install with `sr skills install official/research/qmd` |
...
SR Agent via the native MCP client. This is the preferred
...
Then configure SR Agent to connect via HTTP:
