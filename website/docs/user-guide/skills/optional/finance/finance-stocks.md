...
| | |
|---|---|
| Source | Optional — install with `sr skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), SR Agent |
| License | MIT |
...
```
SCRIPT=~/.sr/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.sr/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
