...
const STORAGE_KEY = "sr-dashboard-theme";
...
const FONT_STORAGE_KEY = "sr-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `sr_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "sr-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-sr-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-sr-theme-font", "true");
