 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `sr_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "SR Teal",
  description: "Classic dark teal — the canonical SR look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "SR Teal (Large)",
  description: "SR Teal with bigger fonts and roomier spacing",
