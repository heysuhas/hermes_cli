 ...
 *
 * Plugins call window.__SR_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__SR_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__SR_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__SR_PLUGIN_SDK__ = {
    ...
    // window.__SR_SESSION_TOKEN__ directly.
    authedFetch,
