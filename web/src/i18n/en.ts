...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateSR: "Update SR",
    updateSRConfirmMessage:
      "This runs sr update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateSRConfirmNow: "Update now",
    updateSRConfirmTitle: "Update SR?",
    updatingSR: "Updating SR…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update SR plugins (`sr plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.sr/plugins/?",
    removeHint: "Only user-installed plugins under ~/.sr/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.sr/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that SR doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible SR badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning SR session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once SR sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "SR is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in SR Agent ☤",
    },
  },
