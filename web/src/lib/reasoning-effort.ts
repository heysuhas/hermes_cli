 ...
 *
 * Values mirror sr_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the SR default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (SR' default when unset). */
